<div id="carouselExampleIndicators" class="carousel slide">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="imagens/file (4).jpg" class="d-block w-100" alt="...">
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Algum texto de exemplo rápido para construir o título do card e preencher o conteúdo do
            card.</p>
